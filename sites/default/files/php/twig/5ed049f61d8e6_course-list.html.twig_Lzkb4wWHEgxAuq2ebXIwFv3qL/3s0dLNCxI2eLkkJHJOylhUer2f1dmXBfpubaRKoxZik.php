  ...
  <input class=\"form-check-input\" type=\"radio\" name=\"englishClass\" value=\"";
    ...
    ";
                ...
                if ( !(null === $this->getAttribute($this->getAttribute($context["result"], "field_a_g", []), 0, [], "array"))) {
                    // line 28
                    echo "    ";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_var_dump($this->env, $context, [0 => $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_a_g", []), 0, [], "array"), "entity", []), "taxonomy_term", []), "value", []))]), "html", null, true);
                    echo "</td>
    ";
                } else {
                    // line 30
...
{% for result in results %}
  ...
  <input class=\"form-check-input\" type=\"radio\" name=\"englishClass\" value=\"{{result.field_course_number[0].value}}\">
    ...
    {{dump(result.field_a_g[0].entity.taxonomy_term.value)}}</td>
    {% else %}
