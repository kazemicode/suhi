...
/* modules/custom/multistep/templates/course-list-elec3.html.twig */
class __TwigTemplate_665cabb117614224dba084285a53283fab1cde4c6aeb3a995401517a92eb293e extends \Twig\Template
{
...
<fieldset class=\"form-container js-form-item form-item js-form-wrapper form-group col-auto\" data-drupal-selector=\"edit-prefs\" id=\"edit-prefs\">
    ...
    <span class=\"fieldset-legend form-instructions\" id=\"select-one\"><h4>🥉 Which <span class=\"name\">";
        // line 11
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["subject"] ?? null)), "html", null, true);
        echo "</span> is your third choice?</h4></span>
  </legend>
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["result"]) {
            ...
            if ((twig_in_filter("Elective", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_graduation_requirement", []), 0, [], "array"), "entity", []), "label", [])) || twig_in_filter("Advanced", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", [])))) {
                // line 24
                echo "   ";
                if ((((($context["isELD"] ?? null) && !twig_in_filter("Fundamentals", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", []))) || (($context["isFund"] ?? null) && !twig_in_filter("Bilingual", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", [])))) || (((($context["isAP"] ?? null) && !twig_in_filter("Fundamentals", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", []))) && !twig_in_filter("SPED", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", []))) && !twig_in_filter("Bilingual", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", []))))) {
                    // line 25
                    echo "    <tr>
    <td>
     ";
                    ...
                    if ((($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_course_number", []), 0, [], "array"), "value", []) != 95176) && ($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_course_number", []), 0, [], "array"), "value", []) != 94239))) {
                        // line 28
                        echo "    <div class=\"js-form-item js-form-type-radio radio form-check js-form-item-elective3 form-item-elective\">
                <input data-drupal-selector=\"edit-elective3\" type=\"radio\" id=\"edit-elective3\" name=\"elective3\" value=\"";
                        // line 29
...
($context["isAP"] ?? null) &&  !($context["isELD"] ?? null)) &&  !($context["isFund"] ?? null)) && !twig_in_filter("Fundamentals", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", []))) && !twig_in_filter("SPED", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", []))) && !twig_in_filter("Bilingual", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", []))) && !twig_in_filter("Advanced Placement", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", [])))) {
                    ...
                    echo "  <tr>
    <td>
    <div class=\"js-form-item js-form-type-radio radio form-check js-form-item-elective3 form-item-elective3\">
                <input data-drupal-selector=\"edit-elective3\" type=\"radio\" id=\"edit-elective3\" name=\"elective3\" value=\"";
                    // line 48
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_course_number", []), 0, [], "array"), "value", [])), "html", null, true);
                    echo "\" class=\"form-radio form-check-input\"> 
...
";
    ...
    {
        return "modules/custom/multistep/templates/course-list-elec3.html.twig";
    }
...
<fieldset class=\"form-container js-form-item form-item js-form-wrapper form-group col-auto\" data-drupal-selector=\"edit-prefs\" id=\"edit-prefs\">
      <legend>
    <span class=\"fieldset-legend form-instructions\" id=\"select-one\"><h4>🥉 Which <span class=\"name\">{{ subject }}</span> is your third choice?</h4></span>
  </legend>
  <div class=\"fieldset-wrapper\">
<table style=\"width:80%\" class=\"table\">
<tr>
...
{% if  (\"Elective\" in result.field_graduation_requirement[0].entity.label) or (\"Advanced\" in result.field_other_attributes[0].entity.label)  %}
   {% if (isELD  and \"Fundamentals\" not in result.field_other_attributes[0].entity.label ) or (isFund and \"Bilingual\" not in result.field_other_attributes[0].entity.label ) or (isAP and \"Fundamentals\" not in result.field_other_attributes[0].entity.label  and \"SPED\" not in result.field_other_attributes[0].entity.label and \"Bilingual\" not in result.field_other_attributes[0].entity.label)  %}
    <tr>
    <td>
     {% if (result.field_course_number[0].value != 95176 and result.field_course_number[0].value != 94239) %}
    <div class=\"js-form-item js-form-type-radio radio form-check js-form-item-elective3 form-item-elective\">
                <input data-drupal-selector=\"edit-elective3\" type=\"radio\" id=\"edit-elective3\" name=\"elective3\" value=\"{{result.field_course_number[0].value}}\" class=\"form-radio form-check-input\"> 
 {% endif %}
</div></td>
...
", "modules/custom/multistep/templates/course-list-elec3.html.twig", "/home/sarkaz/kazemicode.org/suhi/modules/custom/multistep/templates/course-list-elec3.html.twig");
    }
}
