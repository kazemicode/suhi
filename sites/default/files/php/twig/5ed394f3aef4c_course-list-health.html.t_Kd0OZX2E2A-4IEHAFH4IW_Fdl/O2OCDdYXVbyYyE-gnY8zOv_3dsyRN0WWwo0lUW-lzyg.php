...
<tr>
  ...
  <tr>
    ...
    <td>Health requirement already met</td>
    <td>N/A  </td>
    <td> N/A </td></tr>
...
<div class=\"form-header\">
<h2>You'll need to take {{ subject }} before you graduate.</h2></div>

 <div class=\"form-instructions\">
<h4>Select a {{ subject }} course or one of the other options:</h4></div>
<fieldset class=\"form-container js-form-item form-item js-form-wrapper form-group col-auto\" data-drupal-selector=\"edit-prefs\" id=\"edit-prefs\">
      <legend>
    <span class=\"fieldset-legend id=\"select-one\"\">Select one:</span>
  </legend>
...
", "modules/custom/multistep/templates/course-list-health.html.twig", "/app/modules/custom/multistep/templates/course-list-health.html.twig");
    }
}
