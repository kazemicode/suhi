...
<fieldset class=\"form-container js-form-item form-item js-form-wrapper form-group col-auto\" data-drupal-selector=\"edit-prefs\" id=\"edit-prefs\">
      <legend>
    <span class=\"fieldset-legend form-instructions\" id=\"select-one\"><h4>🎭 Select a <span class=\"name\">{{ subject }}</span> course {% if (grade+1) > 9 %} OR that you've completed the requirement{% endif %}:</span>
  </h4></legend>
  <div class=\"fieldset-wrapper\">
<table style=\"width:80%\" class=\"table\">
<tr>
...
", "modules/custom/multistep/templates/course-list-vapa.html.twig", "/home/sarkaz/kazemicode.org/suhi/modules/custom/multistep/templates/course-list-vapa.html.twig");
    }
}
