...
<fieldset class=\"form-container js-form-item form-item js-form-wrapper form-group col-auto\" data-drupal-selector=\"edit-prefs\" id=\"edit-prefs\">
    ...
    <span class=\"fieldset-legend form-instructions\" id=\"select-one\"><h4>🥇 Which <span class=\"name\">";
        // line 11
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["subject"] ?? null)), "html", null, true);
        echo "</span> is your top choice?</h4></span>
  </legend>
    ...
    <td>
     ";
                    ...
                    if ((($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_course_number", []), 0, [], "array"), "value", []) != 95176) && ($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_course_number", []), 0, [], "array"), "value", []) != 94239))) {
                        // line 28
                        echo "    <div class=\"js-form-item js-form-type-radio radio form-check js-form-item-elective form-item-elective\">
...
($context["isAP"] ?? null) &&  !($context["isELD"] ?? null)) &&  !($context["isFund"] ?? null)) && !twig_in_filter("Fundamentals", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", []))) && !twig_in_filter("Bilingual", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", []))) && !twig_in_filter("Advanced Placement", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", []))) && !twig_in_filter("SPED", $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($context["result"], "field_other_attributes", []), 0, [], "array"), "entity", []), "label", [])))) {
                    // line 46
                    echo "  <tr>
    <td>
     ";
...
";
    ...
    {
        return array (  200 => 67,  193 => 65,  189 => 63,  185 => 61,  178 => 58,  176 => 57,  171 => 55,  165 => 54,  161 => 52,  156 => 50,  153 => 49,  151 => 48,  147 => 46,  145 => 45,  139 => 41,  135 => 39,  130 => 37,  127 => 36,  125 => 35,  120 => 33,  114 => 32,  111 => 31,  106 => 29,  103 => 28,  101 => 27,  97 => 25,  94 => 24,  91 => 23,  87 => 22,  73 => 11,  64 => 5,  58 => 2,  55 => 1,);
    }
...
<fieldset class=\"form-container js-form-item form-item js-form-wrapper form-group col-auto\" data-drupal-selector=\"edit-prefs\" id=\"edit-prefs\">
      <legend>
    <span class=\"fieldset-legend form-instructions\" id=\"select-one\"><h4>🥇 Which <span class=\"name\">{{ subject }}</span> is your top choice?</h4></span>
  </legend>
  <div class=\"fieldset-wrapper\">
<table style=\"width:80%\" class=\"table\">
<tr>
...
{% for result in results %}
 ...
 {% endif %}
  ...
  {% elseif  ( not isAP and  not isELD and not isFund and \"Fundamentals\" not in result.field_other_attributes[0].entity.label  and \"Bilingual\" not in result.field_other_attributes[0].entity.label  and  \"Advanced Placement\" not in result.field_other_attributes[0].entity.label and \"SPED\" not in result.field_other_attributes[0].entity.label) %}
  <tr>
    <td>
     {% if (result.field_course_number[0].value != 95176 and result.field_course_number[0].value != 94239) %}
    <div class=\"js-form-item js-form-type-radio radio form-check js-form-item-elective form-item-elective\">
...
", "modules/custom/multistep/templates/course-list-elec.html.twig", "/home/sarkaz/kazemicode.org/suhi/modules/custom/multistep/templates/course-list-elec.html.twig");
    }
}
